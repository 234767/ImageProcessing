...
At the end of each filter there is a function called $apply mask filter$ or $apply mask filter complex$ for complex numbers. Those functions are implemented before the filters, becuase they are responsible for applying the Fourier Transformation and saving processed images to the output files.
